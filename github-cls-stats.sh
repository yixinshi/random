...
repos=("pytorch/xla" "tensorflow/tensorflow" "google/JetStream" "tensorflow/recommenders" "tensorflow/models" "GoogleCloudPlatform/ml-auto-solutions")

# Hardcoded author list
authors=("will-cromar" "richardsliu" "qihqi" "ZhaoyueCheng" "wenxindongwork")
